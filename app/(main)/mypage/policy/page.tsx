  ...
  return (
    ...
    >
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path d="M14 2V8H20" stroke="#4A7C5F" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 13H8" stroke="#4A7C5F" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 17H8" stroke="#4A7C5F" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 9H9H8" stroke="#4A7C5F" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  )
}
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F0EDE8' }}>
      ...
      <div className="px-5 flex flex-col gap-3 pb-10">
        ...
        <div
          ...
          style={{ backgroundColor: '#EEF5F1' }}
        >
          <p className="text-base font-bold mb-3" style={{ color: '#C4973A' }}>
            문의하기
          </p>
